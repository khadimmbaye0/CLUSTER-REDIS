...
redis-cli --cluster create redis-master-1:7001 redis-master-2:7002 redis-master-3:7003 redis-slave-1:7004 redis-slave-2:7005 redis-slave-3:7006 redis-slave-4:7007 redis-slave-5:7008 redis-slave-6:7009 --cluster-replicas 2 --cluster-yes
